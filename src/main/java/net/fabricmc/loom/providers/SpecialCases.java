...
class SpecialCases {
	...
	private static void fixMissingServer(LoomGradleExtension extension, MinecraftVersionInfo version) {
		...
		case "b1.3b":
			serverVersion = "b1.3-2"; //b1.3-221731
			hash = "5cc2aa79b477761cd229d1c3075a6a3afb2bc3ce";
			break;

		case "b1.3": //Omniarchive lists this as b1.3-221713, not listed by the launcher manifest
			serverVersion = "b1.3-1"; //b1.3-221647
			hash = "f077f402b21dba16c653b54cb4518c0ac4d60de2";
			break;
		...
		case "b1.0_01":
			serverVersion = "b1.0_01"; //Sometimes listed as b1.0-2
		...
		case "a1.1.2":
			serverVersion = "a0.2.1-1"; //Unclear how this differs with a0.2.1 (if at all)
